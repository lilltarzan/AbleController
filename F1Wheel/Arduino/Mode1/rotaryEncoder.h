...
int rotationArray[8]; // TODO find a more memory saving way to save rotations, on mega this eats 108 bytes of memory


bool getRotationType1(int pinIn1, int pinIn2, int nr) {
